...
This is to check for any cells with "NA" in the dataset.

```{r}
print(colSums(heart_data == ""))
```
This is to check any blank cells in the dataset
...
A sample usage of the Model (Prototype)
